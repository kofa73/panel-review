...
| 15 | Pending | [Restore event-driven referee seat waiting](15-referee-seat-polling-in-loop.md) | Release-blocking orchestration regression: the referee status hook turns legitimate background waits into high-cost polling loops. |
